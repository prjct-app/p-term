...
public nonisolated enum AppShortcutID: Codable, Hashable, Sendable, CodingKeyRepresentable {
  ...
  public var displayName: String {
    ...
    case .newWorktree: "New Workspace"
    case .refreshWorktrees: "Refresh Workspaces"
    case .archivedWorktrees: "Archived Workspaces"
    case .archiveWorktree: "Archive Workspace"
    case .deleteWorktree: "Delete Workspace"
    case .confirmWorktreeAction: "Confirm Workspace Action"
    case .selectNextWorktree: "Select Next Workspace"
    case .selectPreviousWorktree: "Select Previous Workspace"
    case .worktreeHistoryBack: "Back in Workspace History"
    case .worktreeHistoryForward: "Forward in Workspace History"
    case .selectWorktree(let index): "Select Workspace \(index == 0 ? 10 : index)"
    case .openWorktree: "Open Workspace"
...
public enum AppShortcutCategory: String, CaseIterable, Sendable {
  ...
  public var displayName: String {
    ...
    case .worktreeSelection: "Workspace Selection"
