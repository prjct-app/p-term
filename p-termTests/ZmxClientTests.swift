...
struct ZmxAttachTests {
  ...
  @Test func buildCommandQuotesPathsContainingSpaces() {
    let cmd = ZmxAttach.buildCommand(
      executablePath: "/Applications/prjct.app/Contents/Resources/zmx/zmx",
      sessionID: "s",
      userCommand: nil
    )
    #expect(cmd.hasPrefix("'/Applications/prjct.app/Contents/Resources/zmx/zmx'"))
  }
  ...
  @Test func buildWrapperArgvKeepsSpacedPathAsOneElement() {
    let argv = ZmxAttach.buildWrapperArgv(
      executablePath: "/Applications/prjct Dev.app/Contents/Resources/zmx/zmx",
      sessionID: "prjct-1"
    )
    #expect(argv.count == 3)
    #expect(argv[0] == "/Applications/prjct Dev.app/Contents/Resources/zmx/zmx")
